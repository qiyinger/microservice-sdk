package swust.qiy.microservice.sdk.mq.config;
...
import swust.qiy.microservice.sdk.mq.RocketMqEvent;
import swust.qiy.microservice.sdk.mq.RocketMqProperties;
...
public class MqAutoConfiguration {
  ...
  private static final Logger log = LogManager.getLogger(MqAutoConfiguration.class);
  @Autowired
